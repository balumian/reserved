...
<div class="card mb-3" id="countriesTable"
    data-list='{"valueNames":["title","title_ar","emirate","area","expiry","status","created_on"],"page":10,"pagination":true}'>
    <div class="card-header">
        <div class="row flex-between-center">
            <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Time Slots</h5>
            </div>
            <div class="col-8 col-sm-auto text-end ps-2">
                ...
                <div id="table-customers-replace-element">
                    ...
                    <input class="form-control form-control-sm shadow-none search mb-3" type="search"
                        placeholder="Search..." aria-label="Search">
                    <a href="{{route('business.perks.create')}}" class="disable-link">
            ...
            <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                <thead class="bg-200 text-900">
                    <tr>
                        ...
                        <th class="sort pe-1 align-middle white-space-nowrap" data-sort="emirate">Emirate</th>
                        <th class="sort pe-1 align-middle white-space-nowrap" data-sort="area">Area</th>
                        <th class="sort pe-1 align-middle white-space-nowrap" data-sort="expiry">Expiry</th>
                        <th class="sort pe-1 align-middle white-space-nowrap ps-5" data-sort="status"
                            style="min-width: 200px;">Status</th>
                ...
                @foreach($perks as $perk)
                    ...
                    <tr class="btn-reveal-trigger">
                        <td class="align-middle py-2" style="width: 28px;">
                            <div class="form-check fs-0 mb-0 d-flex align-items-center">
                                <input class="form-check-input" type="checkbox" id="{{$perk->id}}" data-bulk-select-row="data-bulk-select-row" name="bulkselect" value="{{$perk->id}}" />
                            </div>
                        </td>
                        ...
                        <td class="title_ar align-middle white-space-nowrap py-2">
                            {{getAttributeTranslated($perk,'title')}}
                        </td>
                        <td class="emirate align-middle white-space-nowrap py-2">
                           {{get_emirate($perk->emirate_id)}}
                        </td>
                        <td class="area align-middle white-space-nowrap py-2">
                            {{get_area($perk->area_id)}}
                        </td>
                        <td class="expiry align-middle white-space-nowrap py-2">
                            {{$perk->expiry}}
                        </td>
                        <!-- Address -->
                        ...
                        <!-- Created Date -->
                        <td class="created_on align-middle py-2">{{format_date($perk->created_at,'d/m/Y')}}</td>
                        ...
                        <td class="align-middle white-space-nowrap py-2 text-end">
                            <div class="dropdown font-sans-serif position-static">
                                ...
                                <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-0">
                                    <div class="py-2">
                                        <a class="dropdown-item" href="/business/perks/{{$perk->id}}/edit">Edit</a>
                                        <form action="{{route('business.perks.delete')}}" method="post">
                                            @csrf
