...
<div class="card mb-3" id="countriesTable" data-list='{"valueNames":["day","day_ar","working","open","close","status","created_on"],"page":10,"pagination":true}'>
    <div class="card-header">
        <div class="row flex-between-center">
            <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Opening & Closings</h5>
            </div>
            <div class="col-8 col-sm-auto text-end ps-2">
                ...
                <div id="table-customers-replace-element">
                    ...
                    <a href="{{route('business.opening.create')}}" class="disable-link">
            ...
            <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                <thead class="bg-200 text-900">
                    <tr>
                        ...
                        <th class="sort pe-1 align-middle white-space-nowrap" data-sort="day">Day (en)</th>
                        <th class="sort pe-1 align-middle white-space-nowrap" data-sort="day_ar">Day (ar)</th>
                        <th class="sort pe-1 align-middle white-space-nowrap" data-sort="working">Working Day</th>
                        <th class="sort pe-1 align-middle white-space-nowrap" data-sort="open">Opening Time</th>
                        <th class="sort pe-1 align-middle white-space-nowrap" data-sort="close">Closing Time</th>
                ...
                <tbody class="list" id="table-customers-body">
                    ...
                    <tr class="btn-reveal-trigger">
                        <td class="align-middle py-2" style="width: 28px;">
                            <div class="form-check fs-0 mb-0 d-flex align-items-center">
                                <input class="form-check-input" type="checkbox" id="{{$open->id}}" data-bulk-select-row="data-bulk-select-row" name="bulkselect" value="{{$open->id}}" />
                            </div>
                        </td>
                        ...
                        <td class="title_ar align-middle white-space-nowrap py-2">
                            {{getAttributeTranslated($open->day,'day')}}
                        </td>
                        <td class="working align-middle white-space-nowrap py-2">
                            @if($open->working)
                            <span class="badge rounded-pill badge-soft-success">Open</span>
                            @else
                            <span class="badge rounded-pill badge-soft-danger">Close</span>
                            @endif
                        </td>
                        <td class="open align-middle white-space-nowrap py-2">
                            {{$open->open}}
                        </td>
                        <td class="close align-middle white-space-nowrap py-2">
                            {{$open->close}}
                        </td>
                        <!-- Address -->
                        ...
                        <!-- Created Date -->
                        <td class="created_on align-middle py-2">{{format_date($open->created_at,'d/m/Y')}}</td>
                        ...
                        <td class="align-middle white-space-nowrap py-2 text-end">
                            <div class="dropdown font-sans-serif position-static">
                                ...
                                <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-0">
                                    <div class="py-2">
                                        <a class="dropdown-item" href="/business/opening/{{$open->id}}/edit">Edit</a>
                                        <form action="{{route('business.opening.delete')}}" method="post">
                                            @csrf
                                            <input type="hidden" name="data_id" value="{{$open->id}}">
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "{{ route('business.opening.bulk') }}",
                            data: {
                                action: act,
                                list: bulks
                            },
