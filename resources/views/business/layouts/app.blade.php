...
<body>
    ...
    @include('business.partials.toasts')
                ...
                <footer class="footer">
                    <div class="row g-0 justify-content-between fs--1 mt-4 mb-3">
                        <div class="col-12 col-sm-auto text-center">
                            <p class="mb-0 text-600">2023 &copy; <span class="d-none d-sm-inline-block"> | </span><br class="d-sm-none" /> Innovated by <a href="https://innovationbox.ae/">Innovation Box</a></p>
                        </div>
                        <div class="col-12 col-sm-auto text-center">
