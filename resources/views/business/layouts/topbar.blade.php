<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
    ...
    <a class="navbar-brand me-1 me-sm-3" href="{{route('admin.dashboard')}}">
        <div class="d-flex align-items-center"><img class="me-2" src="{{asset('assets/images/rest-logo.jpg')}}" alt="" width="40" /><span class="font-sans-serif" style="color: black;">Reserved</span>
        </div>
    </a>
            ...
            <div class="search-box" data-list='{"valueNames":["title"]}'>
                ...
                <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                        ...
                        <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs--2 pt-0 pb-2">Suggested Filter</h6>
                        ...
                        <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs--2 pt-0 pb-2">Files</h6><a
                            ...
                            <div class="d-flex align-items-center">
                                <div class="file-thumbnail me-2"><img class="border h-100 w-100 fit-cover rounded-3"
                                        src="{{asset('admin/assets/img/products/3-thumb.png')}}" alt="" /></div>
    <div class="flex-1">
    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
                        ...
                        <div class="list-group list-group-flush fw-normal fs--1">
                            ...
                            <div class="list-group-item">
                                <a class="border-bottom-0 notification notification-flush" href="#!">
                                    <div class="notification-avatar">
                                        <div class="avatar avatar-xl me-3">
                                            <img class="rounded-circle" src="{{asset('admin/assets/img/team/10.jpg')}}" alt="" />
        ...
        <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="avatar avatar-xl me-3">
                    ...
                    <img class="rounded-circle" src="{{asset('storage/'.auth()->user()->profile->avatar)}}" alt="" />
                    @else
                    <img class="rounded-circle" src="{{asset('assets/images/rest-logo.jpg')}}" alt="" />
                    @endif
                </div>
            </a>
            <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                <div class="bg-white dark__bg-1000 rounded-2 py-2">
                    ...
                    <a class="dropdown-item" href="{{route('business.account')}}">Profile &amp; account</a>
                    <div class="dropdown-divider"></div>
                    <!-- <a class="dropdown-item" href="#">Settings</a> -->
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <a class="dropdown-item">
                            <button type="submit" style="border:none;background:transparent; padding: 0px; width:100%;text-align: left;">
                                Logout
                            </button>
                        </a>
                    </form>
