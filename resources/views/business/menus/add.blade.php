...
<div class="card mb-3">
    ...
    <div class="card-body bg-light">
        <div class="row">
            <div class="col-lg-8">
                <form action="{{route('business.menu.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                        ...
                        <div class="col-lg-6">
                            <label class="form-label" for="day">Menu Groups <span class="text-danger">*</span></label>
