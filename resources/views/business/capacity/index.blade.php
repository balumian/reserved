...
<div class="card mb-3" id="countriesTable" data-list='{"valueNames":["capacity","capacity_ar","status","created_on"],"page":10,"pagination":true}'>
    <div class="card-header">
        <div class="row flex-between-center">
            <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Booking Capacity</h5>
            </div>
            <div class="col-8 col-sm-auto text-end ps-2">
                ...
                <div id="table-customers-replace-element">
                    ...
                    <a href="{{route('business.capacity.create')}}" class="disable-link">
            ...
            <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                <thead class="bg-200 text-900">
                    <tr>
                        ...
                        <th class="sort pe-1 align-middle white-space-nowrap" data-sort="capacity">Capacity (en)</th>
                        <th class="sort pe-1 align-middle white-space-nowrap" data-sort="capacity">Capacity (ar)</th>
                ...
                <tbody class="list" id="table-customers-body">
                    ...
                    <tr class="btn-reveal-trigger">
                        <td class="align-middle py-2" style="width: 28px;">
                            <div class="form-check fs-0 mb-0 d-flex align-items-center">
                                <input class="form-check-input" type="checkbox" id="{{$capacity->id}}" data-bulk-select-row="data-bulk-select-row" name="bulkselect" value="{{$capacity->id}}" />
                            </div>
                        </td>
                        ...
                        <td class="title_ar align-middle white-space-nowrap py-2">
                            {{getAttributeTranslated($capacity,'capacity')}}
                        </td>
                        <!-- Status -->
                        ...
                        <!-- Created Date -->
                        <td class="created_on align-middle py-2">{{format_date($capacity->created_at,'d/m/Y')}}</td>
                        ...
                        <td class="align-middle white-space-nowrap py-2 text-end">
                            <div class="dropdown font-sans-serif position-static">
                                ...
                                <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-0">
                                    <div class="py-2">
                                        <a class="dropdown-item" href="/business/capacity/{{$capacity->id}}/edit">Edit</a>
                                        <form action="{{route('business.capacity.delete')}}" method="post">
                                            @csrf
                                            <input type="hidden" name="data_id" value="{{$capacity->id}}">
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "{{route('business.capacity.bulk')}}",
                            data: {
                                action: act,
                                list: bulks
                            },
