...
<div class="card mb-3">
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0">Update Menu Group</h5>
            </div>
        </div>
    </div>
    <div class="card-body bg-light">
        <div class="row">
            <div class="col-lg-8">
                <form action="{{route('business.menu.groups.update')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control" id="basic-form-title" type="text" name="title"
                                        id="title" placeholder="Title (en)" required value="{{$group->title}}" />
                                ...
                                <div class="col-lg-6 right-text">
                                    ...
                                    <input class="form-control right-text" id="basic-form-name" type="text"
                                        name="title_ar" id="title_ar" placeholder="(ar) عنوان" value="{{getAttributeTranslated($group,'title')}}" />
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="input-group mb-3">
                                <select class="form-select" name="category" id="category" required>
                                    ...
                                    <option value="{{$cat->id}}" @if($group->menu_cat_id == $cat->id) selected @endif>{{$cat->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" id="flexSwitchCheckChecked" type="checkbox"
                                         name="status" id="status" @if($group->status) checked @endif />
