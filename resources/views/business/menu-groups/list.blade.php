...
<div class="card mb-3" id="countriesTable" data-list='{"valueNames":["title","title_ar","category","status","created_on"],"page":10,"pagination":true}'>
        ...
        <div class="row flex-between-center">
            ...
            <div class="col-8 col-sm-auto text-end ps-2">
                ...
                <div id="table-customers-replace-element">
                    ...
                    <a href="{{route('business.menu.groups.create')}}" class="disable-link">
                ...
                <tbody class="list" id="table-customers-body">
                    ...
                    <tr class="btn-reveal-trigger">
                        <td class="align-middle py-2" style="width: 28px;">
                            <div class="form-check fs-0 mb-0 d-flex align-items-center">
                            <input class="form-check-input" type="checkbox" id="{{$group->id}}" data-bulk-select-row="data-bulk-select-row" name="bulkselect" value="{{$group->id}}" />
                            </div>
                        </td>
                        ...
                        <td class="title_ar align-middle white-space-nowrap py-2">
                            {{getAttributeTranslated($group,'title')}}
                        </td>
                        <td class="category align-middle white-space-nowrap py-2">
                            {{$group->menucategory->title}}
                        </td>
                        <!-- Address -->
                        ...
                        <!-- Created Date -->
                        <td class="created_on align-middle py-2">{{format_date($group->created_at,'d/m/Y')}}</td>
                        ...
                        <td class="align-middle white-space-nowrap py-2 text-end">
                            <div class="dropdown font-sans-serif position-static">
                                ...
                                <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-0">
                                    <div class="py-2">
                                        <a class="dropdown-item" href="/business/menu/groups/{{$group->id}}/edit">Edit</a>
                                        <form action="{{route('business.menu.groups.delete')}}" method="post">
                                            @csrf
                                            <input type="hidden" name="data_id" value="{{$group->id}}">
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "{{ route('business.menu.groups.bulk') }}",
                            data: {
                                action: act,
                                list: bulks
                            },
