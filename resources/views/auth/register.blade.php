        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12 align-self-center">
                <div class="login-form">
                    ...
                    <form method="POST" action="{{ route('register') }}" id="customer-signup">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12">
                                <div class="input-bg">
                                    ...
                                    <input type="text" class="input-item" id="name" placeholder="" name="name">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="input-bg">
                                    ...
                                    <input type="password" class="input-item" id="password_confirmation" placeholder="" name="password_confirmation">
                                    <p class="text-danger">{{$errors->first('password_confirmation')}}</p>

                                </div>
                            </div>
                            <div class="custom-radio-bg custom-checkbox-bg ">
                                <div class="custom-radio">
                                    <input type="checkbox" id="terms" class="radio-custom checkbox-custom" name="terms" value="Terms & Conditions">
                                    <label for="terms" class="radio-custom-label"><em>I agree to the <a href="#" target="_blank">Terms &amp; Conditions</a> </em></label>
                                </div>
                            </div>
