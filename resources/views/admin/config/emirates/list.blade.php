...
<div class="card mb-3" id="countriesTable" data-list='{"valueNames":["name","name_ar","status","created_on"],"page":10,"pagination":true}'>
        ...
        <div class="row flex-between-center">
            ...
            <div class="col-8 col-sm-auto text-end ps-2">
                ...
                <div id="table-customers-replace-element">
                    ...
                    <a href="{{route('admin.emirate.create')}}" class="disable-link">
                ...
                <tbody class="list" id="table-customers-body">
                    ...
                    <tr class="btn-reveal-trigger">
                        <td class="align-middle py-2" style="width: 28px;">
                            <div class="form-check fs-0 mb-0 d-flex align-items-center">
                                <input class="form-check-input" type="checkbox" id="{{$emirate->id}}" data-bulk-select-row="data-bulk-select-row" name="bulkselect" value="{{$emirate->id}}" />
                            </div>
                        </td>
                        ...
                        <td class="name align-middle white-space-nowrap py-2">
                            {{getAttributeTranslated($emirate,'name')}}
                        </td>
                        ...
                        <!-- Created Date -->
                        <td class="joined align-middle py-2">{{format_date($emirate->created_at,'d/m/Y')}}</td>
                        ...
                        <td class="align-middle white-space-nowrap py-2 text-end">
                            <div class="dropdown font-sans-serif position-static">
                                ...
                                <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-0">
                                    <div class="py-2"><a class="dropdown-item" href="/admin/emirate/{{$emirate->id}}/edit">Edit</a>
