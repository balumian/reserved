...
<div class="card mb-3" id="countriesTable" data-list='{"valueNames":["feature","title","title_ar","status","created_on"],"page":10,"pagination":true}'>
    <div class="card-header">
        <div class="row flex-between-center">
            <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Experiences</h5>
            </div>
            <div class="col-8 col-sm-auto text-end ps-2">
                ...
                <div id="table-customers-replace-element">
                    ...
                    <a href="{{route('admin.experience.create')}}" class="disable-link">
            ...
            <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                <thead class="bg-200 text-900">
                    <tr>
                        ...
                        <th class="sort pe-1 align-middle white-space-nowrap" data-sort="title_ar">Title_ar (ar)</th>
                ...
                <tbody class="list" id="table-customers-body">
                    ...
                    <tr class="btn-reveal-trigger">
                        <td class="align-middle py-2" style="width: 28px;">
                            <div class="form-check fs-0 mb-0 d-flex align-items-center">
                                <input class="form-check-input" type="checkbox" id="{{$experience->id}}" data-bulk-select-row="data-bulk-select-row" name="bulkselect" value="{{$experience->id}}" />
                            </div>
                        </td>
                        <td class="title align-middle white-space-nowrap py-2">
                            <div class="avatar avatar-xl me-2">
                                @if($experience->feature)
                                <img class="rounded-circle" src="{{asset('storage/'.$experience->feature)}}" alt="">
                                @else
                                <div class="avatar-name rounded-circle">
                                    <span>{{get_custom_avatar($experience->title)}}</span>
                                </div>
                                @endif
                            </div>
                        </td>
                        ...
                        <td class="title_ar align-middle white-space-nowrap py-2">
                            {{getAttributeTranslated($experience,'title')}}
                        </td>
                        <!-- Address -->
                        ...
                        <!-- Created Date -->
                        <td class="created_on align-middle py-2">{{format_date($experience->created_at,'d/m/Y')}}</td>
                        ...
                        <td class="align-middle white-space-nowrap py-2 text-end">
                            <div class="dropdown font-sans-serif position-static">
                                ...
                                <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-0">
                                    <div class="py-2">
                                        <a class="dropdown-item" href="/admin/experience/{{$experience->id}}/edit">Edit</a>
                                        <form action="{{route('admin.experience.delete')}}" method="post">
                                            @csrf
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('admin.experience.bulk') }}",
                        data: {
                            action: act,
                            list: bulks
                        },
