...
<div class="card mb-3" id="countriesTable"
    data-list='{"valueNames":["title","title_ar","status","created_on"],"page":10,"pagination":true}'>
    <div class="card-header">
        <div class="row flex-between-center">
            <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Amenities</h5>
            </div>
            <div class="col-8 col-sm-auto text-end ps-2">
                ...
                <div id="table-customers-replace-element">
                    ...
                    <a href="{{route('admin.amenities.create')}}" class="disable-link">
                ...
                <tbody class="list" id="table-customers-body">
                    ...
                    <tr class="btn-reveal-trigger">
                        <td class="align-middle py-2" style="width: 28px;">
                            <div class="form-check fs-0 mb-0 d-flex align-items-center">
                            <input class="form-check-input" type="checkbox" id="{{$amenity->id}}" data-bulk-select-row="data-bulk-select-row" name="bulkselect" value="{{$amenity->id}}" />
                            </div>
                        </td>
                        ...
                        <td class="title_ar align-middle white-space-nowrap py-2">
                            {{getAttributeTranslated($amenity,'title')}}
                        </td>
                        <!-- Address -->
                        ...
                        <!-- Created Date -->
                        <td class="created_on align-middle py-2">{{format_date($amenity->created_at,'d/m/Y')}}</td>
                        ...
                        <td class="align-middle white-space-nowrap py-2 text-end">
                            <div class="dropdown font-sans-serif position-static">
                                ...
                                <div class="dropdown-menu dropdown-menu-end border py-0"
                                    ...
                                    <div class="py-2">
                                        <a class="dropdown-item" href="/admin/amenities/{{$amenity->id}}/edit">Edit</a>
                                        <form action="{{route('admin.amenities.delete')}}" method="post">
                                            @csrf
                                            <input type="hidden" name="data_id" value="{{$amenity->id}}">
                                            <button type="submit"
                                                class="dropdown-item text-danger confirmation">Delete</button>
                                        </form>
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('admin.amenities.bulk') }}",
                        data: {
                            action: act,
                            list: bulks
                        },
