    ...
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0">Add New Cuisines</h5>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control-sm" id="cuisine-feature" name="feature" type="file" onchange="cuisineURLimg(this);" accept=".jpg,.png,.jpeg" required>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="row">
