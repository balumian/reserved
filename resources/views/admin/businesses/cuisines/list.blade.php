    ...
    <div class="card-header">
        <div class="row flex-between-center">
            <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Cuisines</h5>
            </div>
            <div class="col-8 col-sm-auto text-end ps-2">
                ...
                <div id="table-customers-replace-element">
                    ...
                    <a href="{{route('admin.cuisines.create')}}" class="disable-link">
                ...
                <tbody class="list" id="table-customers-body">
                    ...
                    <tr class="btn-reveal-trigger">
                        <td class="align-middle py-2" style="width: 28px;">
                            <div class="form-check fs-0 mb-0 d-flex align-items-center">
                                <input class="form-check-input" type="checkbox" id="{{$cuisine->id}}" data-bulk-select-row="data-bulk-select-row" name="bulkselect" value="{{$cuisine->id}}" />
                            </div>
                        </td>
                        <td class="photo align-middle white-space-nowrap py-2">
                            <div class="avatar avatar-xl me-2">
                                @if($cuisine->feature)
                                <img class="rounded-circle" src="{{asset('storage/'.$cuisine->feature)}}" alt="">
                                @else
                                <div class="avatar-name rounded-circle">
                                    <span>{{get_custom_avatar($cuisine->title)}}</span>
                                </div>
                                @endif
                        ...
                        <td class="title_ar align-middle white-space-nowrap py-2">
                            {{getAttributeTranslated($cuisine,'title')}}
                        </td>
                        <!-- Address -->
                        ...
                        <!-- Created Date -->
                        <td class="created_on align-middle py-2">{{format_date($cuisine->created_at,'d/m/Y')}}</td>
                        ...
                        <td class="align-middle white-space-nowrap py-2 text-end">
                            <div class="dropdown font-sans-serif position-static">
                                ...
                                <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-0">
                                    <div class="py-2">
                                        <a class="dropdown-item" href="/admin/cuisines/{{$cuisine->id}}/edit">Edit</a>
                                        <form action="{{route('admin.cuisines.delete')}}" method="post">
                                            @csrf
