<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
    ...
    <a class="navbar-brand me-1 me-sm-3" href="{{route('admin.dashboard')}}">
        <div class="d-flex align-items-center"><img class="me-2" src="{{asset('assets/images/rest-logo.jpg')}}"
                alt="" width="40" /><span class="font-sans-serif" style="color: black;">Reserved</span>
        </div>
    </a>
                ...
                <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                        ...
                        <a class="dropdown-item px-x1 py-2" href="#!">
                            <div class="d-flex align-items-center">
                                <div class="file-thumbnail me-2"><img class="img-fluid" src="{{asset('admin/assets/img/icons/zip.png')}}"
                                        alt="" /></div>
                                <div class="flex-1">
    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
        ...
        <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button"
                ...
                <div class="avatar avatar-xl">
                    <img class="rounded-circle" src="{{asset('admin/assets/img/team/3-thumb.png')}}" alt="" />
