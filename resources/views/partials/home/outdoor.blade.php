<section class="home-rest-list">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h2>Outdoor Restaurant <a href="{{route('restaurants-listing')}}">View all</a></h2>
				...
				<div class="rest-list">
					<div class="owl-carousel trending-rest owl-theme">
						...
						<div class="item rest-card">
							<div class="rest-card-img">
								<a href="{{route('restaurant-detail')}}">
								<img class="img-fluid" src="assets/images/restu-6.jpg">
								</a>	
								<div class="rest-card-tags">
									<div class="tag-cusines">
						...
						<div class="item rest-card">
							<div class="rest-card-img">
								<a href="{{route('restaurant-detail')}}">
								<img class="img-fluid" src="assets/images/restu-7.jpg">
								</a>	
								<div class="rest-card-tags">
									<div class="tag-cusines">
						...
						<div class="item rest-card">
							<div class="rest-card-img">
								<a href="{{route('restaurant-detail')}}">
								<img class="img-fluid" src="assets/images/restu-8.jpg">
								</a>	
								<div class="rest-card-tags">
									<div class="tag-cusines">
						...
						<div class="item rest-card">
							<div class="rest-card-img">
								<a href="{{route('restaurant-detail')}}">
								<img class="img-fluid" src="assets/images/restu-9.jpg">
								</a>	
								<div class="rest-card-tags">
									<div class="tag-cusines">
										<span class="c-tag">Arabic</span>
