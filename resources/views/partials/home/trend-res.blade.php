<section class="home-rest-list">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h2>Trending Restaurant <a href="{{route('restaurants-listing')}}">View all</a></h2>
				
				<div class="rest-list">
					<div class="owl-carousel trending-rest owl-theme">

						@foreach($business as $item)
						<div class="item rest-card">
							<div class="rest-card-img">
								<a href="{{route('restaurant-detail')}}">
								<img class="img-fluid" src="assets/images/restu-1.jpg">
								</a>	
						...
						<!-- <div class="item rest-card">
							<div class="rest-card-img">
								<a href="{{route('restaurant-detail')}}">
								<img class="img-fluid" src="assets/images/restu-2.jpg">
								</a>	
								<div class="rest-card-tags">
									<div class="tag-cusines">
						...
						<div class="item rest-card">
							<div class="rest-card-img">
								<a href="{{route('restaurant-detail')}}">
								<img class="img-fluid" src="assets/images/restu-3.jpg">
								</a>	
								<div class="rest-card-tags">
									<div class="tag-cusines">
						...
						<div class="item rest-card">
							<div class="rest-card-img">
								<a href="{{route('restaurant-detail')}}">
								<img class="img-fluid" src="assets/images/restu-4.jpg">
								</a>	
								<div class="rest-card-tags">
									<div class="tag-cusines">
						...
						<div class="item rest-card">
							<div class="rest-card-img">
								<a href="{{route('restaurant-detail')}}">
								<img class="img-fluid" src="assets/images/restu-5.jpg">
								</a>	
								<div class="rest-card-tags">
									<div class="tag-cusines">
										<span class="c-tag">Arabic</span>
